...
void DecayEnvelope::setSampleRate(float newSampleRate)
{
...
void DecayEnvelope::setDecayTimeConstant(float newTimeConstant)
{
...
bool DecayEnvelope::endIsReached(float threshold)
{
  if( y < threshold )
    return true;
  else
